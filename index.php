...
<body>
    <section class="congratulations">
        ...
        <p>This is project with Proxmox + Jenkins + AWS Elastic Beanstalk + Zabbix + Docker+ Jenkins email notification(Mail extended) <em>PHP</em> application is now running on own dedicated environment in the AWS&nbsp;Cloud</p>
